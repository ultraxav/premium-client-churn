...
# premium_client_churn documentation build
...
from premium_client_churn import __version__ as release
...
htmlhelp_basename = "premium_client_churndoc"
...
latex_documents = [
    (
        master_doc,
        "premium_client_churn.tex",
        "premium_client_churn Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "premium_client_churn",
        "Project premium_client_churn codebase.",
        "Data-Science",
    )
]
